...
<!-- E-ARK ERMS Schematron rules version 2.2.0 -->
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern id="co-occurrence-constraints">
        ...
        <rule context="*[@addressType = 'other']">
        ...
        <rule context="*[@contactType = 'other']">
        ...
        <rule context="erms:disposalDate[@dateType = 'other_date']">
            <assert test="normalize-space(@otherDisposalDateType)" > If the element <emph>disposalDate</emph> is using attribute <emph>dateType</emph> with value 'other_date', then the <emph>otherDisposalDateType</emph> attribute should be used </assert>
        </rule>
